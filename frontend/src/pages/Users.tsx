        ...
        {users.map((user) => (
          ...
          >
            ...
            <div className='flex space-x-3 pt-3 border-t border-gray-200'>
              <button
                onClick={() => handleEditUser(user)}
                className='flex-1 bg-blue-50 text-blue-600 hover:bg-blue-100 px-3 py-2 rounded-md text-sm font-medium text-center'
              >
                Edit
              </button>
              <button
                onClick={() => handleDeleteUser(user.id)}
                className='flex-1 bg-red-50 text-red-600 hover:bg-red-100 px-3 py-2 rounded-md text-sm font-medium text-center'
              >
                Delete
              </button>
            </div>
