-- Phase 7: Migrate from BigInt IDs to UUIDs (Corrected version)
...
ALTER TABLE skus DROP CONSTRAINT IF EXISTS skus_pkey;
...
ALTER TABLE field_aliases DROP CONSTRAINT IF EXISTS field_aliases_pkey;
...
-- Step 7: Drop old ID columns and rename UUID columns to replace them
...
-- Step 12: Update any check constraints
